...
bool NetLib::connectToServer()
{
    ...
    if (getsockname(sock_, reinterpret_cast<sockaddr*>(&boundAddr), &addrLen) == 0) {
...
bool NetLib::sendPacket(const Packet& packet)
{
...
void NetLib::handlePacket(const Packet& packet)
{
